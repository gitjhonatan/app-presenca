...
export class ChatPage implements OnInit {
	...
	initText = {
		...
		pmsp: "Olá, gostaria de obter maiores informações sobre a <b>margem pré-aprovada</b> para funcionários da prefeitura de São Paulo",
		govsp: "Olá, gostaria de obter maiores informações sobre a <b>margem pré-aprovada</b> para funcionários do Governo do Estado de São Paulo"
	}
